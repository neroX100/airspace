  ...
  return (
    <main className="flex flex-col bg-white p-4">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <Link to="/properties" className='py-2 md:py-3 px-6 md:px-8 w-max border border-solid border-slate-700 text-slate-700 text-sm md:text-base rounded-full'>See More</Link>
        </div>
